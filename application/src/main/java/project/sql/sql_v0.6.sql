...
--
-- Host: localhost
-- Generation Time: Jan 12, 2017 at 10:01 PM
...
INSERT INTO `USER` (`USER_ID`, `EMAIL`, `MOBILE`, `PASSWORD`, `NAME`, `GENDER`, `CITY`, `VERI_CODE`, `SSID`, `SALT`, `CREATE_DTM`, `MOD_DTM`) VALUES
(6, 'vishalva06@gmail.com', '8124627522', 'test', 'Vishal', 'Male', 'Chennai', 'VERIFIED', 'o6dbss6gsdp6kvmfa3o51cfc44', '', '2017-01-10 01:15:09', NULL),
(7, 'test', '2525', 'Y2FzZWxXTTgx', 'kabali', 'm', 'madras', 'Ed7WYkNUfO', '', 'bFdNODE=', '2017-01-12 23:29:02', NULL),
(8, 'dial2vishal@gmail.com', '7503876065', 'cm9ja012bE5W', 'vishal', 'Male', 'madras', 'COUWfMQGuo', '', 'TXZsTlY=', '2017-01-13 02:22:19', NULL);
